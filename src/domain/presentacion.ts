...
/**
 * Tonos semánticos del sistema. Viven en el dominio porque expresan significado
 * —vencido, en tiempo, urgente—, no estilo. La capa de interfaz los traduce a
 * colores; si vivieran en el componente, el dominio dependería de la UI.
 */
export type Tono = 'neutro' | 'verde' | 'ambar' | 'rojo' | 'azul' | 'marca'
