...
export default async function PaginaAdmin() {
  ...
  const secciones = [
    ...
    { href: '/admin/manuales', icono: BookOpen, titulo: 'Manuales de operación', cuenta: null,
      texto: 'Cómo opera la plataforma y qué le toca a cada perfil: ciudadano, atención, cuadrilla, supervisión, dirección y administración. Para imprimir o mandar a cada persona.' },
  ]
